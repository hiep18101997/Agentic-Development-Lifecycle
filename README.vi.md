...
```
.claude/skills/      # 32 Claude Code Agent Skills, mỗi skill 1 folder với SKILL.md (canonical source)
...
Repo này là framework source. "Sản phẩm" là skill files cho cả hai nền tảng — `.claude/skills/` và `.opencode/skills/` (mỗi bên 32 files).
